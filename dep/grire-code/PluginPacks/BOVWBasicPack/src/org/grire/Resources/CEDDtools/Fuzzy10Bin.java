...
package org.grire.Resources.CEDDtools;

public class Fuzzy10Bin {
    public boolean KeepPreviuesValues = false;


    protected static float[] HueMembershipValues = {0, 0, 5, 10,
            5, 10, 35, 50,
            35, 50, 70, 85,
            70, 85, 150, 165,
            150, 165, 195, 205,
    ...
    protected static float[] SaturationMembershipValues = {0, 0, 10, 75,
            10, 75, 255, 255};

    protected static float[] ValueMembershipValues = {0, 0, 10, 75,
            10, 75, 180, 220,
            180, 220, 255, 255};
    ...
    public float[] Fuzzy10BinHisto = new float[10];
    public static float[] HueActivation = new float[8];
    public static float[] SaturationActivation = new float[2];
    public static float[] ValueActivation = new float[3];
    ...
    private void LOM_Defazzificator(FuzzyRules[] Rules, float[] Input1, float[] Input2, float[] Input3, float[] ResultTable) {
    ...
    private void MultiParticipate_Equal_Defazzificator(FuzzyRules[] Rules, float[] Input1, float[] Input2, float[] Input3, float[] ResultTable) {
    ...
    private void MultiParticipate_Defazzificator(FuzzyRules[] Rules, float[] Input1, float[] Input2, float[] Input3, float[] ResultTable) {
    ...
    public float[] ApplyFilter(float Hue, float Saturation, float Value, int Method) {
        // Method   0 = LOM
