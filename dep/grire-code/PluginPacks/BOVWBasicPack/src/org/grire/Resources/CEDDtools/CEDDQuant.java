...
public class CEDDQuant {
    ...
    public float[] Apply(float[] Local_Edge_Histogram)

    {

        float[] Edge_HistogramElement = new float[Local_Edge_Histogram.length];

        float[] ElementsDistance = new float[8];
...

        {
...

            {
                ...
                ElementsDistance[j] = (float) Math.abs(Local_Edge_Histogram[i] - QuantTable[j] / 1000000);
...

        {
...

            {
                ...
                ElementsDistance[j] = (float) Math.abs(Local_Edge_Histogram[i] - QuantTable2[j] / 1000000);
...

        {
...

            {
                ...
                ElementsDistance[j] = (float)Math.abs(Local_Edge_Histogram[i] - QuantTable3[j] / 1000000);
...

        {
...

            {
                ...
                ElementsDistance[j] =(float) Math.abs(Local_Edge_Histogram[i] - QuantTable4[j] / 1000000);
...

        {
...

            {
                ...
                ElementsDistance[j] =(float) Math.abs(Local_Edge_Histogram[i] - QuantTable5[j] / 1000000);
...

        {
...

            {
                ...
                ElementsDistance[j] =(float) Math.abs(Local_Edge_Histogram[i] - QuantTable6[j] / 1000000);
